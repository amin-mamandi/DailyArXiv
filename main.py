...
current_date = datetime.now(chicago_timezone).strftime("%Y-%m-%d")
...
keywords = ["Computer Architecture", "embedded systems", "real-time systems", "Computer Systems", "Memory regulation"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/tangwen-qian/DailyArXiv) page for a better reading experience and more papers.**\n\n")
